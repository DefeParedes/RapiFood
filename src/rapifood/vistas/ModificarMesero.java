 ...
 * @author Fedep
 */
public class ModificarMesero extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarMesero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
